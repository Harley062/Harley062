...
<h1 align="center">Olá, eu sou Harley Gonçalves Teixeira 👋</h1>
...
## 🏢 Experiência
| Período | Empresa / Cargo | Impacto |
|---------|-----------------|---------|
| 2025-Atual | **Synthexa Integration Technology**<br/>Desenvolvedor Full-Stack Pleno | IA e microsserviços escaláveis · pipelines CI/CD · automação de operações |
| 2024-Atual | **H.Tech Consultoria**<br/>Desenvolvedor Full-Stack Pleno | Sistemas web completos · integrações API-first · performance tuning |
| 2023-2025 | **Conveste Serviços Financeiros**<br/>Full-Stack Dev | ASP.NET Core · Docker · Azure DevOps · Python & Data Lakes |
| 2022-2023 | **Conveste Serviços Financeiros**<br/>Infra & RPA | Automação UiPath · gestão de VMs · monitoramento |
